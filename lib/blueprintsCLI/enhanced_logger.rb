...
module BlueprintsCLI
  ...
  class EnhancedLogger
    ...
    private def enhanced_log(level, message = nil, **data)
    ...
    private def extract_context(skip_frames = 3)
    ...
    private def extract_method_name(skip_frames)
    ...
    private def extract_class_name(skip_frames)
    ...
    private def extract_command_class_name(path)
    ...
    private def extract_action_class_name(path)
    ...
    private def extract_service_class_name(path)
    ...
    private def build_context_by_level(class_name, method_name, caller_info)
