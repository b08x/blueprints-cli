...
module BlueprintsCLI
  module UI
    ...
    module PreviewBoxes
      ...
      module_function def info_box(content, title: "Information", **)
        create_box(content, title:, style: :info, **)
      end
      ...
      module_function def code_box(content, title: "Code", **)
        create_box(content, title:, style: :code, **)
      end
      ...
      module_function def highlighted_code_box(content, title: "Code", language: nil, **options)
        ...
        highlighted_content = Utils::CodeFormatter.format_for_box(content, language:)
        ...
        create_box(highlighted_content, title:, style: :code, **box_options)
      end
      ...
      # @param options [Hash] Additional TTY::Box options
      # @return [String] The formatted box
      module_function def warning_box(content, title: "Warning", **)
        create_box(content, title:, style: :warning, **)
      end
      ...
      # @param options [Hash] Additional TTY::Box options
      # @return [String] The formatted box
      module_function def error_box(content, title: "Error", **)
        create_box(content, title:, style: :error, **)
      end
      ...
      # @param options [Hash] Additional TTY::Box options
      # @return [String] The formatted box
      module_function def diff_box(content, title: "Comparison", **)
        create_box(content, title:, style: :diff, **)
      end
      ...
      # @param options [Hash] Additional TTY::Box options
      # @return [String] The formatted box
      module_function def success_box(content, title: "Success", **)
        create_box(content, title:, style: :success, **)
      end
      ...
      # @param options [Hash] Additional TTY::Box options
      # @return [String] The formatted box
      module_function def metadata_box(content, title: "Metadata", **)
        create_box(content, title:, style: :metadata, **)
      end
      ...
      # @param options [Hash] Additional TTY::Box options
      # @return [String] The formatted box
      module_function def description_box(content, title: "Description", **)
        create_box(content, title:, style: :description, **)
      end
      ...
      # @param options [Hash] Additional TTY::Box options
      # @return [String] The formatted box
      module_function def suggestions_box(content, title: "AI Suggestions", **)
        create_box(content, title:, style: :suggestions, **)
      end
      ...
      module_function def side_by_side(left_content, right_content,
