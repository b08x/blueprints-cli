  ...
  module Utils
    ...
    class CodeFormatter
      class << self
        ...
        private def highlight_with_rouge(code, language)
        ...
        private def clean_trailing_codes(highlighted)
          cleaned = highlighted
        ...
        private def find_lexer(language)
        ...
        private def map_to_rouge_language(language)
