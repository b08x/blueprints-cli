...
module BlueprintsCLI
  module Setup
    ...
    class ConfigGenerator
      ...
      private def build_database_config
      ...
      private def build_rubyllm_config
      ...
      private def build_provider_specific_config
        # Add any provider-specific settings
        return unless @setup_data[:providers]&.key?(:openai) || @setup_data[:providers]&.key?(:openrouter)

        @generated_config[:ai][:openai] = { log_errors: true }
      end

      # Build logger configuration section
      private def build_logger_config
      ...
      private def build_editor_config
      ...
      private def build_performance_config
      ...
      private def validate_configuration
        ...
        required_sections.each do |section|
          raise StandardError, "Missing required configuration section: #{section}" unless @generated_config[section]
        end
      ...
      private def backup_existing_config
      ...
      private def generate_yaml_content
        content = "---\n"
      ...
      private def generate_logger_yaml_section
        content = "logger:\n"
      ...
      private def generate_remaining_yaml_sections
        content = ""
      ...
      private def target_config_path
      ...
      private def update_environment_instructions
