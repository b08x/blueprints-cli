  ...
  module UI
    module StdoutRouter
      class Writer
        ...
        private def prepend_id(stream, args)
        ...
        private def prepend_id_for_stream(stream)
      ...
      class Capture
        ...
        class << self
          ...
          sig { returns(T::Boolean) }
          private def outermost_uncaptured?
      ...
      class << self
        ...
        private def activate(stream, streamname)
